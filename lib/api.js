...
export const API_ENDPOINTS = {
  ...
  // Products (prefix: products) - ADDED MISSING ENDPOINTS
  PRODUCTS: "/products",
  PRODUCTS_BRANDS: "/products/brands", // NEW
  PRODUCTS_FILTERS: "/products/filters", // NEW
...
export const authAPI = {
  ...
  // Products - UPDATED WITH NEW METHODS
  getProducts: (params = {}) => {
  ...
  // NEW: Get available brands
  getBrands: () => apiCall(API_ENDPOINTS.PRODUCTS_BRANDS),

  // NEW: Get filter options (price range, rating range, categories)
