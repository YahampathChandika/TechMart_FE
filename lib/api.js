...
export const API_ENDPOINTS = {
  ...
  USERS: "/admin/users",
  USERS_STATISTICS: "/admin/users/statistics",

  // Customers Management (prefix: customers)
  CUSTOMERS: "/admin/customers",
  CUSTOMERS_STATISTICS: "/admin/customers/statistics",
  CUSTOMERS_TOP: "/admin/customers/top-customers",
...
export const authAPI = {
  ...
  getUserPrivileges: (userId) =>
    apiCall(`${API_ENDPOINTS.USERS}/${userId}/privileges`),

  updateUserPrivileges: (userId, privilegeData) =>
    apiCall(`${API_ENDPOINTS.USERS}/${userId}/privileges`, {
      method: HTTP_METHODS.PUT,
  ...
  toggleUserStatus: (userId, isActive) =>
    apiCall(`${API_ENDPOINTS.USERS}/${userId}/toggle-status`, {
