// components/customer/SearchFilters.js - Updated for proper brand handling
"use client";
...
export const SearchFilters = ({
  ...
  // Debug logging
  console.log("SearchFilters - availableFilters:", availableFilters);
  console.log("SearchFilters - brands:", availableFilters?.brands);
  console.log("SearchFilters - current filters:", localFilters);
